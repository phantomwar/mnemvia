...
[English](README.md) · [Dependências](DEPENDENCIES.md) · [Roadmap](ROADMAP.md) · [Contribuição](CONTRIBUTING.md)
...
Mnemvia é o nome escolhido. Nenhuma marca, domínio ou namespace foi registrado neste planejamento.
