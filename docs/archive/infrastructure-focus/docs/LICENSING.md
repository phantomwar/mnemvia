...
Decision date: 2026-09-18. Project: Opseld. Selected license: **Apache-2.0**.
...
| Candidate | Main distinction | Decision for Opseld |
|---|---|---|
...
Model weights, imported datasets, private incident evidence, external reports and third-party components are not relicensed by placing a reference to them in this repository. Record the license and source of every redistributed component and review the actual combination, rather than assuming separate processes automatically remove obligations.
